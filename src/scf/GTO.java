    ...
    public static double getSderiv(GTO a, GTO b, int tau) {
        ...
        switch (tau) {
            case 0:
                ...
                return a.getN() * b.getN() * Ideriv(a.i, b.i, a.exponent, b.exponent, b.coordinates[0] - a.coordinates[0]) *
                        I(a.j, b.j, a.exponent, b.exponent, b.coordinates[1] - a.coordinates[1]) *
                        I(a.k, b.k, a.exponent, b.exponent, b.coordinates[2] - a.coordinates[2]);
            case 1:
                return a.getN() * b.getN() * I(a.i, b.i, a.exponent, b.exponent, b.coordinates[0] - a.coordinates[0]) *
            ...
            case 0:
                switch (B) {
                    case 0: //derivative wrt x and x
                        return a.getN() * b.getN() * Ideriv2(a.i, b.i, a.exponent, b.exponent, b.coordinates[0] - a.coordinates[0]) *
                                I(a.j, b.j, a.exponent, b.exponent, b.coordinates[1] - a.coordinates[1]) *
                                I(a.k, b.k, a.exponent, b.exponent, b.coordinates[2] - a.coordinates[2]);
        ...
        switch (l1) {
            case 0:
                switch (l2) {
                    ...
                    case 1:
                        return 2 * a1 * a1 * a2 * R / ((a1 + a2) * (a1 + a2)) * num * (3 - 2 * a1 * a2 / (a1 + a2) * R * R);
                }
                break;
            case 1:
                switch (l2) {
                    case 0:
                        return 2 * a1 * a2 * a2 * R / ((a1 + a2) * (a1 + a2)) * num * (2 * a1 * a2 / (a1 + a2) * R * R - 3);
                    case 1:
                        return a1 * a2  * Math.pow(a1 + a2, -2) * num * (2 * R * a1 * a2 / (a1 + a2)  * (3 * R - 2 * R * R * R * a1 * a2 / (a1 + a2))+ 6 * R * R * a1 * a2 / (a1 + a2) - 3);
                }
                break;
        }
