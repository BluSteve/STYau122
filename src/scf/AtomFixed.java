...
public abstract class AtomFixed { // abstract class. Consists of an array of LCGTO
	// objects (ie. the valence orbitals), a coordinate array, an atomic charge Z and a
	// core charge Q.
	protected double[] coordinates;
	protected AtomProperties atomProperties;

	public AtomFixed(AtomProperties atomProperties,
					 double[] coordinates) { // HAS AtomProperties and coordinates
