...
public class STO6G extends LCGTO {
    ...
    private final static double[] exp1 = new double[]{6.51095E-2, 1.58088E-1, 4.07099E-1, 1.18506, 4.23592, 2.31030E+1};

    private final static double[] coeff1 = new double[]{1.30334E-1, 4.16492E-1, 3.70563E-1, 1.68538E-1, 4.93615E-2, 9.16360E-3};

    private final static double[] exp2 = new double[]{4.85690E-2, 1.05960E-1, 2.43977E-1, 6.34142E-1, 2.04036, 1.03087E+1};

    private final static double[] coeff2s = new double[]{2.40706E-1, 5.95117E-1, 2.50242E-1, -3.37854E-2, -4.69917E-2, -1.32528E-2};
