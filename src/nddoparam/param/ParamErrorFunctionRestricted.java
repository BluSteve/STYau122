...
public class ParamErrorFunctionRestricted extends ParamErrorFunction {
	...
	protected double getDeriv(double[] coeff, int atom2) {
		double deriv =
				coeff[0] * NDDODerivative.grad((NDDOSolutionRestricted) expSoln, atom2
						, 0)
						+ coeff[1] *
						NDDODerivative.grad((NDDOSolutionRestricted) expSoln, atom2, 1)
						+ coeff[2] *
						NDDODerivative.grad((NDDOSolutionRestricted) expSoln, atom2, 2);
