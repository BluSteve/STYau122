...
public class NDDOParamDerivative {
    ...
    private static double qQpipi(double p01, double p11, double p21, double D11, double D21, double p02, double p12, double p22, double D12, double D22, double R, int num, double D1deriv, double D2deriv, double p1deriv, double p2deriv) {
        double a02 = p01 + p22;
    ...
    private static double QpizQpiz(double p01, double p11, double p21, double D11, double D21, double p02, double p12, double p22, double D12, double D22, double R, int num, double D1deriv, double D2deriv, double p1deriv, double p2deriv) {
        ...
        if (num == 0) {
            return  - 0.125 * ((R + 2 * D21 - 2 * D22) * D2deriv + a22 * p2deriv) * Math.pow((R + D21 - D22) * (R + D21 - D22) + (D21 - D22) * (D21 - D22) + a22 * a22, -1.5)
                    ...
                    - 0.125 * ((2 * D21 + 2 * D22 - R) * D2deriv + a22 * p2deriv) * Math.pow((R - D21 - D22) * (R - D21 - D22) + (D21 + D22) * (D21 + D22) + a22 * a22, -1.5)
                    - 0.125 * ((2 * D21 - 2 * D22 - R) * D2deriv + a22 * p2deriv) * Math.pow((R - D21 + D22) * (R - D21 + D22) + (D21 - D22) * (D21 - D22) + a22 * a22, -1.5)
                    + 0.125 * ((2 * D21 - R) * D2deriv + a22 * p2deriv) * Math.pow((R - D21 + D22) * (R - D21 + D22) + (D21 + D22) * (D21 + D22) + a22 * a22, -1.5);
        }
        if (num == 1) {
            return  - 0.125 * ((2 * D22 - 2 * D21 - R) * D2deriv + a22 * p2deriv) * Math.pow((R + D21 - D22) * (R + D21 - D22) + (D21 - D22) * (D21 - D22) + a22 * a22, -1.5)
                    ...
                    + 0.125 * ((2 * D22 - R) * D2deriv + a22 * p2deriv) * Math.pow((R - D21 - D22) * (R - D21 - D22) + (D21 - D22) * (D21 - D22) + a22 * a22, -1.5)
                    - 0.125 * ((2 * D21 + 2 * D22 - R) * D2deriv + a22 * p2deriv) * Math.pow((R - D21 - D22) * (R - D21 - D22) + (D21 + D22) * (D21 + D22) + a22 * a22, -1.5)
                    - 0.125 * ((2 * D22 + R - 2 * D21) * D2deriv + a22 * p2deriv) * Math.pow((R - D21 + D22) * (R - D21 + D22) + (D21 - D22) * (D21 - D22) + a22 * a22, -1.5)
                    + 0.125 * ((R + 2 * D22) * D2deriv + a22 * p2deriv) * Math.pow((R - D21 + D22) * (R - D21 + D22) + (D21 + D22) * (D21 + D22) + a22 * a22, -1.5);
        }
                        ...
                        switch (c.getL()) {
                            ...
                            case 0: //(ss|s?);
                                ...
                                switch (d.getL()) {
                                    ...
                                    case 0://(ss|ss)
                                        return ssssderiv(a.p0, a.p1, a.p2, a.D1, a.D2, c.p0, c.p1, c.p2, c.D1, c.D2, R, num, D1deriv, D2deriv, p1deriv, p2deriv);

                                    case 1:
                                        if (d.getk() == 1) {//(ss|spz)
                                            return ssspzderiv(a.p0, a.p1, a.p2, a.D1, a.D2, c.p0, c.p1, c.p2, c.D1, c.D2, R, num, D1deriv, D2deriv, p1deriv, p2deriv);
                                        } else {//(ss|sppi) = 0
                                            return 0;
                                        }
                                    default:
                            ...
                            case 1: //(ss|p?)
                                if (c.getk() == 1) {//(ss|pz?)
                                    ...
                                    switch (d.getL()) {
                                        ...
                                        case 1:
                                            if (d.getk() == 1) {//(ss|pzpz)
                                                return sspzpzderiv(a.p0, a.p1, a.p2, a.D1, a.D2, c.p0, c.p1, c.p2, c.D1, c.D2, R, num, D1deriv, D2deriv, p1deriv, p2deriv);
                                            } else {//(ss|pzppi) = 0
                                                return 0;
                                            }
                                        default:
                                    ...
                                    if (d.getL() == 1 && d.getk() == 0 && c.geti() == d.geti() && c.getj() == d.getj()) {//(ss|ppippi)
                                        return ssppippideriv(a.p0, a.p1, a.p2, a.D1, a.D2, c.p0, c.p1, c.p2, c.D1, c.D2, R, num, D1deriv, D2deriv, p1deriv, p2deriv);
                            ...
                            switch (c.getL()) {
                                ...
                                case 0://(spz|s?)
                                    ...
                                    switch (d.getL()) {
                                        ...
                                        case 0://(spz|ss)
                                            return spzssderiv(a.p0, a.p1, a.p2, a.D1, a.D2, c.p0, c.p1, c.p2, c.D1, c.D2, R, num, D1deriv, D2deriv, p1deriv, p2deriv);

                                        case 1:
                                            if (d.getk() == 1) {//(spz|spz)
                                                return spzspzderiv(a.p0, a.p1, a.p2, a.D1, a.D2, c.p0, c.p1, c.p2, c.D1, c.D2, R, num, D1deriv, D2deriv, p1deriv, p2deriv);
                                            } else {
                                                return 0;
                                            }
                                    }
                                ...
                                case 1:
                                    if (c.getk() == 1) {//(spz|pz?)
                                        ...
                                        switch (d.getL()) {
                                            ...
                                            case 1:
                                                if (d.getk() == 1) {//(spz|pzpz)
                                                    return spzpzpzderiv(a.p0, a.p1, a.p2, a.D1, a.D2, c.p0, c.p1, c.p2, c.D1, c.D2, R, num, D1deriv, D2deriv, p1deriv, p2deriv);
                                                } else {//(spz|pzppi) = 0
                                                    return 0;
                                                }
                                        }
                                        ...
                                        if (d.geti() == c.geti() && d.getj() == c.getj() && d.getk() == 0) {
                                            return spzppippideriv(a.p0, a.p1, a.p2, a.D1, a.D2, c.p0, c.p1, c.p2, c.D1, c.D2, R, num, D1deriv, D2deriv, p1deriv, p2deriv);
                                        } else {
                                            return 0;
                                        }
                                    }
                            ...
                            switch (c.getL()) {
                                case 0://(sppi|s?)
                                    if (d.geti() == b.geti() && d.getj() == b.getj() && d.getk() == 0) {//(sppi|sppi)
                                        return sppisppideriv(a.p0, a.p1, a.p2, a.D1, a.D2, c.p0, c.p1, c.p2, c.D1, c.D2, R, num, D1deriv, D2deriv, p1deriv, p2deriv);
                                    } else {
                                        return 0;
                                    }
                                case 1:
                                    if (c.getk() == 1) {
                                        if (d.geti() == b.geti() && d.getj() == b.getj() && d.getk() == 0) {//(sppi|pzppi)
                                            return sppippipzderiv(a.p0, a.p1, a.p2, a.D1, a.D2, c.p0, c.p1, c.p2, c.D1, c.D2, R, num, D1deriv, D2deriv, p1deriv, p2deriv);
                                        } else {
                                            return 0;
                                        }
                                    } else {
                                ...
                                switch (c.getL()) {
                                    ...
                                    case 0://(pzpz|s?)
                                        ...
                                        switch (d.getL()) {
                                            ...
                                            case 0://(pzpz|ss)
                                                return pzpzssderiv(a.p0, a.p1, a.p2, a.D1, a.D2, c.p0, c.p1, c.p2, c.D1, c.D2, R, num, D1deriv, D2deriv, p1deriv, p2deriv);

                                            case 1:
                                                if (d.getk() == 1) {//(pzpz|spz)
                                                    return pzpzspzderiv(a.p0, a.p1, a.p2, a.D1, a.D2, c.p0, c.p1, c.p2, c.D1, c.D2, R, num, D1deriv, D2deriv, p1deriv, p2deriv);
                                                } else {
                                                    return 0;
                                                }
                                        }
                                    ...
                                    case 1:
                                        if (c.getk() == 1) {//(pzpz|pz?)
                                            ...
                                            switch (d.getL()) {
                                                ...
                                                case 1:
                                                    if (d.getk() == 1) {//(pzpz|pzpz)
                                                        return pzpzpzpzderiv(a.p0, a.p1, a.p2, a.D1, a.D2, c.p0, c.p1, c.p2, c.D1, c.D2, R, num, D1deriv, D2deriv, p1deriv, p2deriv);
                                                    } else {//(pzpz|pzppi) = 0
                                                        return 0;
                                                    }
                                            }
                                            ...
                                            if (d.geti() == c.geti() && d.getj() == c.getj() && d.getk() == 0) {
                                                return pzpzppippideriv(a.p0, a.p1, a.p2, a.D1, a.D2, c.p0, c.p1, c.p2, c.D1, c.D2, R, num, D1deriv, D2deriv, p1deriv, p2deriv);
                                            } else {
                                                return 0;
                                            }
                                        }
                                ...
                                switch (c.getL()) {
                                    case 0://(pzppi|s?)
                                        if (d.geti() == b.geti() && d.getj() == b.getj() && d.getk() == 0) {//(pzppi|sppi)
                                            return ppipzsppideriv(a.p0, a.p1, a.p2, a.D1, a.D2, c.p0, c.p1, c.p2, c.D1, c.D2, R, num, D1deriv, D2deriv, p1deriv, p2deriv);
                                        } else {
                                            return 0;
                                        }
                                    case 1:
                                        if (c.getk() == 1) {
                                            if (d.geti() == b.geti() && d.getj() == b.getj() && d.getk() == 0) {//(pzppi|pzppi)
                                                return ppipzppipzderiv(a.p0, a.p1, a.p2, a.D1, a.D2, c.p0, c.p1, c.p2, c.D1, c.D2, R, num, D1deriv, D2deriv, p1deriv, p2deriv);
                                            } else {
                                                return 0;
                                            }
                                        } else {
                                        ...
                                        switch (d.getL()) {
                                            case 0://(ppippi|ss)
                                                if (a.geti() == b.geti() && a.getj() == b.getj()) {
                                                    return ppippissderiv(a.p0, a.p1, a.p2, a.D1, a.D2, c.p0, c.p1, c.p2, c.D1, c.D2, R, num, D1deriv, D2deriv, p1deriv, p2deriv);
                                                } else {
                                                    return 0;
                                                }
                                            case 1:
                                                if (d.getk() == 1 && a.geti() == b.geti() && a.getj() == b.getj()) {
                                                    return ppippispzderiv(a.p0, a.p1, a.p2, a.D1, a.D2, c.p0, c.p1, c.p2, c.D1, c.D2, R, num, D1deriv, D2deriv, p1deriv, p2deriv);
                                                } else {
                                                    return 0;
                                                }
                                        }
                                        ...
                                        if (c.getk() == 1) {
                                            switch (d.getL()) {
                                                ...
                                                case 1:
                                                    if (d.getk() == 1 && a.geti() == b.geti() && a.getj() == b.getj()) {//(ppippi|pzpz)
                                                        return ppippipzpzderiv(a.p0, a.p1, a.p2, a.D1, a.D2, c.p0, c.p1, c.p2, c.D1, c.D2, R, num, D1deriv, D2deriv, p1deriv, p2deriv);
                                                    } else {
                                                        return 0;
                                                    }
                                            }
                                            ...
                                            if (a.geti() == b.geti() && a.getj() == b.getj()) {//(pxpx|??) or (pypy|??)
                                                ...
                                                if (c.getL() == d.getL() && c.geti() == d.geti() && c.getj() == d.getj() && c.getk() == 0) {
                                                    if (a.geti() == c.geti()) {
                                                        return ppippippippideriv(a.p0, a.p1, a.p2, a.D1, a.D2, c.p0, c.p1, c.p2, c.D1, c.D2, R, num, D1deriv, D2deriv, p1deriv, p2deriv);
                                                    } else {
                                                        return pxpxpypyderiv(a.p0, a.p1, a.p2, a.D1, a.D2, c.p0, c.p1, c.p2, c.D1, c.D2, R, num, D1deriv, D2deriv, p1deriv, p2deriv);
                                                    }
                                                } else {
                                                    return 0;
                                                }
                                                ...
                                                if (c.getL() == d.getL() && c.geti() != d.geti() && c.getj() != d.getj() && c.getk() == 0) {
                                                    return pxpypxpyderiv(a.p0, a.p1, a.p2, a.D1, a.D2, c.p0, c.p1, c.p2, c.D1, c.D2, R, num, D1deriv, D2deriv, p1deriv, p2deriv);
                                                }
                                            }
                                        }
                ...
                for (int k = 0; k < coeffC.length; k++) {
                    for (int l = 0; l < coeffD.length; l++) {
                        ...
                        if (coeffA[i] * coeffB[j] * coeffC[k] * coeffD[l] != 0) {
                            sum2 += coeffA[i] * coeffB[j] * coeffC[k] * coeffD[l] * LocalTwoCenterERIderiv(A[i], B[j], C[k], D[l], D1deriv, D2deriv, p1deriv, p2deriv, num, type) * 27.21;
                        }
    ...
    public static double[] MNDOHfderivs (NDDOAtom[] atoms, NDDOSolutionRestricted soln, int Z) {

        double[] derivs = new double[8];

        derivs[0] = alphaHfderiv (atoms, soln, Z);
        derivs[1] = betaHfderiv(soln, Z, 0);
        derivs[3] = uxxHfderiv(soln, Z, 0);
        derivs[5] = zetaHfderiv(atoms, soln, Z, 0);
        derivs[7] = eisolHfderiv(atoms, Z);

        if (Z != 1) {
            derivs[2] = betaHfderiv(soln, Z, 1);
            derivs[4] = uxxHfderiv(soln, Z, 1);
            derivs[6] = zetaHfderiv(atoms, soln, Z, 1);
    ...
    public static DoubleMatrix[][] MNDOmatrixderivstatic (NDDOSolutionRestricted soln, int Z) {
        ...
        Hderivs[2] = uxxfockderivstatic(soln, Z, 0);
        Fderivs[2] = Hderivs[2].dup();
        Hderivs[4] = zetaHderivstatic(atoms, soln, Z, 0);
        Fderivs[4] = Hderivs[4].dup().add(zetaGderivstatic(atoms, soln, Z, 0));

        if (Z != 1) {
            Hderivs[1] = betafockderivstatic(soln, Z, 1);
            Fderivs[1] = Hderivs[1].dup();
            Hderivs[3] = uxxfockderivstatic(soln, Z, 1);
    ...
    public static double MNDOHfderiv (NDDOSolutionRestricted soln, DoubleMatrix Hderiv, DoubleMatrix Fderiv) {
        ...
        for (int j = 0; j < soln.orbitals.length; j++) {
            for (int k = 0; k < soln.orbitals.length; k++) {
                e += 0.5 * densitymatrix.get(j, k) * (Hderiv.get(j, k) + Fderiv.get(j, k));
            }
        }
        ...
        for (int j = 0; j < orbitals.length; j++) {
            for (int k = j; k < orbitals.length; k++) {
                if (atomNumber[j] != atomNumber[k]) {
                    ...
                    double H = betaderiv(atomicnumbers[atomNumber[j]], atomicnumbers[atomNumber[k]], Z, orbitals[j].getL(), orbitals[k].getL(), type);
    ...
    private static DoubleMatrix computeResponseVectorsComplete(DoubleMatrix x, NDDOSolutionRestricted soln) {//todo legacy/deprecated
        ...
        DoubleMatrix R = DoubleMatrix.zeros(NOcc * soln.orbitals.length - NOcc, 1);
        ...
        for (int i = 0; i < NOcc; i++) {
            for (int j = 0; j < soln.orbitals.length; j++) {
                ...
                if (i != j) {
                    ...
                    for (int u = 0; u < soln.orbitals.length; u++) {
                        for (int v = 0; v < soln.orbitals.length; v++) {
                            element += soln.C.get(i, u) * soln.C.get(j, v) * responsematrix.get(u, v);
                        }
                    }
        ...
        DoubleMatrix p = new DoubleMatrix (NOcc * soln.orbitals.length - NOcc, 1);
        ...
        for (int i = 0; i < NOcc; i++) {
            for (int j = 0; j < soln.orbitals.length; j++) {
                if (i != j) {
                    p.put (counter, 0, -R.get(counter, 0) + (soln.E.get(j) - soln.E.get(i)) * x.get(counter));
                    counter++;
                }
            }
        }
    ...
    private static DoubleMatrix computeResponseVectorsIncomplete(DoubleMatrix x, NDDOSolutionRestricted soln) {
            ...
            for (int v = 0; v < densityMatrixDeriv.columns; v++) {
                ...
                for (int i = 0; i < NOcc; i++) {
                    if (i < NOcc - 1) {
                        ...
                        sum -= 2 * (soln.C.get(i, u) * soln.C.get(NOcc - 1, v) + soln.C.get(NOcc - 1, u) * soln.C.get(i, v)) * x.get(count, 0);
                        count++;
        ...
        DoubleMatrix R = DoubleMatrix.zeros(NOcc * NVirt + 2 * (NOcc - 1), 1);
        ...
        for (int i = 0; i < NOcc; i++) {
            if (i < NOcc - 1) {
                ...
                for (int u = 0; u < soln.orbitals.length; u++) {
                    for (int v = 0; v < soln.orbitals.length; v++) {
                        elementt += soln.C.get(i, u) * soln.C.get(NOcc - 1, v) * responsematrix.get(u, v);
                    }
                }


                R.put(count1, 0, elementt);
        ...
        DoubleMatrix p = new DoubleMatrix (NOcc * NVirt + 2 * (NOcc - 1), 1);
        ...
        for (int i = 0; i < NOcc; i++) {
            if (i < NOcc - 1) {
                ...
                p.put (counter, 0, -R.get(counter, 0) + (soln.E.get(NOcc - 1) - soln.E.get(i)) * x.get(counter));
                counter++;
    ...
    public static DoubleMatrix[] xarraycomplete (NDDOSolutionRestricted soln, DoubleMatrix[] fockderivstatic) {
        ...
        for (int a = 0; a < Farray.length; a++) {
            DoubleMatrix F = DoubleMatrix.zeros(NOcc * soln.orbitals.length - NOcc, 1);
            ...
            for (int i = 0; i < NOcc; i++) {
                for (int j = 0; j < soln.orbitals.length; j++) {
                    ...
                    if (i != j) {
                        ...
                        for (int u = 0; u < soln.orbitals.length; u++) {
                            for (int v = 0; v < soln.orbitals.length; v++) {
                                element += soln.C.get(i, u) * soln.C.get(j, v) * fockderivstatic[a].get(u, v);
                            }
                        }
            ...
            xarray[a] = DoubleMatrix.zeros(NOcc * soln.orbitals.length - NOcc, 1);
        ...
        if (dirs[0].rows == 0) {
            DoubleMatrix[] xderivs = new DoubleMatrix[fockderivstatic.length];

            for (int i = 0; i <xderivs.length; i++) {
                xderivs[i] = DoubleMatrix.zeros (0, 0);
            }
        ...
        while (numNotNull(rarray) > 0) {
            ...
            for (int i = 0; i < d.size(); i++) {
                p.add (computeResponseVectorsComplete(d.get(i), soln));
            }
    ...
    public static DoubleMatrix[] xarrayincomplete (NDDOSolutionRestricted soln, DoubleMatrix[] fockderivstatic) {
        ...
        for (int a = 0; a < Farray.length; a++) {
            DoubleMatrix F = DoubleMatrix.zeros(NOcc * NVirt + 2 * (NOcc - 1), 1);
            ...
            for (int i = 0; i < NOcc; i++) {
                if (i < NOcc - 1) {
                    ...
                    for (int u = 0; u < soln.orbitals.length; u++) {
                        for (int v = 0; v < soln.orbitals.length; v++) {
                            elementt += soln.C.get(i, u) * soln.C.get(NOcc - 1, v) * fockderivstatic[a].get(u, v);
                        }
                    }


                    F.put(count1, 0, elementt);
            ...
            xarray[a] = DoubleMatrix.zeros(NOcc * NVirt + 2 * (NOcc - 1), 1);
        ...
        while (numNotNull(rarray) > 0) {
            ...
            for (int i = 0; i < d.size(); i++) {
                p.add (computeResponseVectorsIncomplete(d.get(i), soln));
            }
    ...
    public static DoubleMatrix HOMOcoefficientDerivativeIncomplete (DoubleMatrix x, NDDOSolutionRestricted soln) {
        ...
        for (int u = 0; u < soln.orbitals.length; u++) {
            ...
            for (int k = 0; k < soln.orbitals.length; k++) {
                ...
                if (k < NOcc) {
                    sum -= soln.C.get(k, u) * x.get((NOcc - 1) * NVirt + NOcc - 1 + k, 0);
                }
                else if (k > NOcc) {
                    sum -= soln.C.get(k, u) * x.get((NOcc - 1) * NVirt + NOcc - 1 + (k - 1), 0);
                }
            }
    ...
    public static double MNDOIEDeriv (NDDOSolutionRestricted soln, DoubleMatrix coeffDeriv, DoubleMatrix Fderiv) {
        ...
        for (int i = 0; i < soln.orbitals.length; i++) {
            for (int j = 0; j < soln.orbitals.length; j++) {
                sum += soln.F.get(i, j) * (coeff.get(i) * coeffDeriv.get(j) + coeff.get(j) * coeffDeriv.get(i));
    ...
    public static double MNDODipoleDeriv (NDDOSolutionRestricted soln, DoubleMatrix densityderiv, int Z, int paramnum) {
        ...
        for (int j = 0; j < atoms.length; j++) {
            chargedip[0] += 2.5416 * populationsderiv[j] * (atoms[j].getCoordinates()[0] - com[0]);
            chargedip[1] += 2.5416 * populationsderiv[j] * (atoms[j].getCoordinates()[1] - com[1]);
            chargedip[2] += 2.5416 * populationsderiv[j] * (atoms[j].getCoordinates()[2] - com[2]);
        }
        ...
        for (int j = 0; j < atoms.length; j++) {
            ...
            if (index[j][1] != -1) {//exclude hydrogen
                hybridip[0] = hybridip[0] - 2.5416 * 2 * atoms[j].D1 * densityderiv.get(index[j][0], index[j][1]);
                hybridip[1] = hybridip[1] - 2.5416 * 2 * atoms[j].D1 * densityderiv.get(index[j][0], index[j][2]);
                hybridip[2] = hybridip[2] - 2.5416 * 2 * atoms[j].D1 * densityderiv.get(index[j][0], index[j][3]);

                if (atoms[j].getAtomProperties().getZ() == Z) {
                    hybridip[0] = hybridip[0] - 2.5416 * 2 * D1deriv * densityMatrix.get(index[j][0], index[j][1]);
                    hybridip[1] = hybridip[1] - 2.5416 * 2 * D1deriv * densityMatrix.get(index[j][0], index[j][2]);
                    hybridip[2] = hybridip[2] - 2.5416 * 2 * D1deriv * densityMatrix.get(index[j][0], index[j][3]);
                }
            }
        ...
        double[] dipoletot = new double[]{chargedip[0] + hybridip[0], chargedip[1] + hybridip[1], chargedip[2] + hybridip[2]};


        return (dipoletot[0] * soln.dipoletot[0] + dipoletot[1] * soln.dipoletot[1] + dipoletot[2] * soln.dipoletot[2]) / soln.dipole;
    }
