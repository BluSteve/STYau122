...
public class ParamGradientUnrestricted extends ParamGradient {
	public ParamGradientUnrestricted(NDDOAtom[] atoms, int charge, int mult, int Z,
									 int paramNum, NDDOSolutionUnrestricted s) {
	...
	public void createExpGeom(NDDOAtom[] expAtoms, NDDOSolution expSoln) {
		if (eprime != null) {
			...
			eprime.createExpGeom(
					new NDDOSolutionUnrestricted(perturbedExp, expSoln.charge,
							expSoln.multiplicity));
		}
