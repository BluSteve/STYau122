...
public class AM1Atom extends NDDOAtom {
    ...
    public double crf(NDDOAtom c) {
        ...
        return f * this.atomProperties.getQ() * b.atomProperties.getQ() * NDDO6G.getG(this.s(), this.s(), b.s(), b.s()) + (F(this, R) + F(b, R)) * this.getAtomProperties().getQ() * b.getAtomProperties().getQ() / R;
    }
    ...
    public double crfDeriv(NDDOAtom c, int tau) {
        ...
        double reciprocalderiv = -this.atomProperties.getQ() * b.atomProperties.getQ() / (r * r) * (this.getCoordinates()[tau] - b.getCoordinates()[tau]) / (R * bohr);

        double gaussiancontribution = (Fderiv(this, R, this.getCoordinates()[tau] - b.getCoordinates()[tau]) + Fderiv(b, R, this.getCoordinates()[tau] - b.getCoordinates()[tau])) * this.atomProperties.getQ() * b.atomProperties.getQ() / r + reciprocalderiv * (F(this, r) + F(b, r));

        double returnval = fprime * this.atomProperties.getQ() * b.atomProperties.getQ() * NDDO6G.getG(this.s(), this.s(), b.s(), b.s()) + f * this.atomProperties.getQ() * b.atomProperties.getQ() * NDDODerivative.getGderiv(this.s(), this.s(), b.s(), b.s(), tau) + gaussiancontribution;
