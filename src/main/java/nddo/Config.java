...
public class Config {
	public final double rhf_diiserror_limit = 1e-12, rhf_diiserror_tolerable = 5e-12;
	public final int rhf_numIt_tolerable = 3000, rhf_numIt_max = 100000;
	public final double uhf_diiserror_limit = 5E-13, uhf_diiserror_tolerable = 1e-12;
	public final int uhf_numIt_tolerable = 3000, uhf_numIt_max = 100000;
	public final int rhf_thiel_limit = 10000, uhf_thiel_limit = 10000;
	public final int geom_opt_hessian_interval = 7;
	public final String logging_level = "info";
