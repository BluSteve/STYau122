...
public class MNDO6G extends STO6G{
	...
	public MNDO6G(int i, int j, int k, double[] coordinates, int shell, int Z, MNDOAtom a, double zeta, double beta, double U, double p0, double p1, double p2, double D1, double D2, double gss, double gsp, double hsp, double gpp, double gp2) {
		
		super(i, j, k, coordinates, shell, Z, a, zeta);
	...
	public MNDO6G (int i, int j, int k, double[] coordinates, double zeta, double beta, double U, double p0, double p1, double p2, double D1, double D2, double gss, double gsp, double hsp, double gpp, double gp2) {
		super.i = i;
		super.j = j;
		super.k = k;
		super.L = i + j + k;
	...
	public MNDO6G (MNDO6G reference, double[] coords) {
		this(reference.i, reference.j, reference.k, coords, reference.shell, reference.Z, null, reference.zeta, reference.beta, reference.U,reference.p0, reference.p1, reference.p2, reference.D1, reference.D2, reference.gss, reference.gsp, reference.hsp, reference.gpp, reference.gp2);
	}
