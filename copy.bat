...
copy build\libs\MNDOParam_proguard.jar \\192.168.31.153\sambashare\home\steve\Downloads\mndo-server\MNDOParam.jar

ssh steve@34.72.220.21 -i C:\Users\billi\Documents\stevecyr "sudo ./mndo-update.sh"